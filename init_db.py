...
def initialize_database():
    ...
    # 3. SEED TOURS
    cursor.execute("INSERT INTO tours VALUES (1, 1, 'Colosseum & Ancient Rome Walk', 'Colosseum Metro Exit', 120, 'English', 15, 'Explore the grandeur of the Roman Empire, from the legendary gladiatorial arena to the political heart of the Roman Forum.', 'Colosseum,Roman Forum', 'colosseum1.jpg,colosseum2.jpg,colosseum3.jpg,colosseum4.jpg,colosseum5.jpg')")
    cursor.execute("INSERT INTO tours VALUES (2, 1, 'Vatican Secrets Tour', 'St. Peters Square Obelisk', 180, 'Italian', 10, 'A journey beyond the surface: discover the artistic masterpieces and historical mysteries hidden within the walls of the Vatican.', 'St. Peters Square,Basilica', 'vatican1.jpg,vatican2.jpg,vatican3.jpg,vatican4.jpg,vatican5.jpg')")
    cursor.execute("INSERT INTO tours VALUES (3, 4, 'Trastevere Evening Food Tour', 'Piazza Trilussa', 150, 'Spanish', 12, 'Savor the true taste of Rome as you wander through cobbled streets of Trastevere, sampling local delicacies and artisanal gelato.', 'Trastevere,Bakery,Gelateria', 'trastevere1.jpg,trastevere2.jpg,trastevere3.jpg,trastevere4.jpg,trastevere5.jpg')")
    cursor.execute("INSERT INTO tours VALUES (4, 1, 'Pantheon & Hidden Gems', 'Piazza della Rotonda', 90, 'English', 20, 'Marvel at the architectural perfection of the Pantheon and uncover the charming, lesser-known fountains and piazzas of historic Rome.', 'Pantheon,Trevi Fountain,Navona', 'pantheon1.jpg,pantheon2.jpg,pantheon3.jpg,pantheon4.jpg,pantheon5.jpg')")
    cursor.execute("INSERT INTO tours VALUES (5, 4, 'Roman Catacombs Underground', 'Piazza Venezia Bus Stop', 240, 'German', 8, 'A hauntingly beautiful journey beneath the earth to explore ancient burial sites and secret passages that tell the story of early Rome.', 'Appian Way,Catacombs of San Callisto', 'catacombs1.jpg,catacombs2.jpg,catacombs3.jpg,catacombs4.jpg,catacombs5.jpg')")
