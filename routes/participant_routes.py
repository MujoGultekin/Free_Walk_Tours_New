...
# Defining the participant Blueprint for tour-related operations
...
def tour_detail(tour_id):
    ...
    # Splitting photos string into a list for the carousel component
...
def book_tour(tour_id):
    ...
    # Validate that the number of guest names matches the selected guest count
...
def cancel_booking(res_id):
    ...
    if res and res["participant_id"] == current_user.id:
        ...
        # Verify if cancellation is requested at least 24 hours in advance
